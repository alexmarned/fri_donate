...
function catch_that_image() {
  ...
  if(empty($first_img)){ //Defines a default image
    $first_img = "<img src='http://localhost/wordpress/wp-content/uploads/2021/08/003_f-yvel.jpg'>";
  }
  return $first_img;
}


//значения для медиафайлов по умолчанию start
...
//значения для медиафайлов по умолчанию end
